...
class COCODataset(JointsDataset):
    ...
    def __init__(self, cfg, root, image_set, is_train, transform=None):
        ...
        self.img_path = cfg.DATASET.ROOT+'/images/'+cfg.DATASET.FOLDER+'/'
    ...
    def _load_coco_keypoint_annotations(self):
        ...
        for index in self.image_set_index:
            item = self._load_coco_keypoint_annotation_kernal(index)
    ...
    def _coco_keypoint_results_one_category_kernel(self, data_pack):
        ...
        for img_kpts in keypoints:
            ...
            result = [{'image_id': img_kpts[k]['image'],
                       ...
                       'file_name': img_kpts[k]['file_name']
                       } for k in range(len(img_kpts))]
